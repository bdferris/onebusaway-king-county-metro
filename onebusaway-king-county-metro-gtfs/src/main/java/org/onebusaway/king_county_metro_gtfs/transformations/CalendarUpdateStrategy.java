...
public class CalendarUpdateStrategy implements GtfsTransformStrategy {
  ...
  public void run(TransformContext context, GtfsMutableRelationalDao dao) {
    ...
    MetroKCDao metrokcDao = DaoStrategy.getDao(context);
    ...
    Map<Trip, List<MetroKCChangeDate>> changeDateMapping = KingCountyMetroUpdateLibrary.getChangeDatesByTrip(
        dao, metrokcDao);
    Map<Trip, MetroKCTrip> tripMapping = KingCountyMetroUpdateLibrary.getMetroKCTripsByGtfsTrip(
